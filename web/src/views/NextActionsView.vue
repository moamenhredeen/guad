...
<template>
  <div class="mx-auto max-w-200">
    ...
    <p class="mt-0.5 text-[13px] text-grau-50">
      {{ filteredActions.length }} actions across {{ groupedByContext.size }} contexts
    </p>
      ...
      <button
        ...
        :class="
          activeContextId === null
            ? 'bg-schwarz text-white'
            : 'bg-grau-5 text-schwarz hover:bg-grau-10'
        "
    ...
    <div v-else class="mt-4">
      <div v-for="[contextName, contextActions] in groupedByContext" :key="contextName">
        <TaskRow
