...
<template>
  <div>
    ...
    <p class="mt-0.5 text-[13px] text-grau-50">{{ projects.items.length }} active projects</p>
    ...
    <div v-else class="mt-4">
      <div v-for="[areaName, areaProjects] in groupedByArea" :key="areaName" class="mb-4">
        <h3 class="text-xs font-semibold uppercase tracking-wide text-grau-80">{{ areaName }}</h3>
