...
class LibraryFeaturePresentationConventionPlugin : Plugin<Project> {
    override fun apply(target: Project) {
        with(target) {
            with(pluginManager) {
                apply("app.guad.convention.library.cmp")
            }
            ...
            project.afterEvaluate {
                dependencies {
                    configurations.findByName("androidMainImplementation")?.let {
